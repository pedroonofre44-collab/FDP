...
<div class="screen active" id="s-join">
  <div class="jcard">
    ...
    <div id="join-err" style="color:var(--red2);font-size:12px;margin-top:.45rem;display:none"></div>
  </div>
</div>
...
function connect() {
  ...
  ws.onopen  = () => { setC(true); if (myName) send({action:'join',name:myName}); };
  ws.onclose = () => { setC(false); setTimeout(connect,2000); };
